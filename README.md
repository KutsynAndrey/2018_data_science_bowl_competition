...
* **my_balanced_modelv1** &mdash; model with minimum Dice coefficient 0.44. It was trained using batch_size=32,  
n_epochs=20, image_size=128 and learning_rate=0.003
